        ...
        <div className="px-5 py-3 border-b dark:border-gray-700">
          <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 rounded-xl px-3 py-2">
            ...
            <input
              ...
              className="bg-transparent border-none outline-none text-sm flex-1 dark:text-gray-100 dark:placeholder-gray-500"
            />
          </div>
        </div>
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map(t => (
              <button
                ...
                className="w-full text-left px-5 py-3 hover:bg-[#6bbfd4]/10 transition-colors border-b dark:border-gray-700 last:border-0"
              >
                <p className="font-medium text-gray-900 dark:text-gray-50 text-sm">{t.name || '(Kein Name)'}</p>
                {t.description && (
