...
export default function RubrikenView({
  ...
  return (
    <div className="flex-1 overflow-auto bg-gray-100 dark:bg-gray-800">
      ...
      <div className="px-4 py-3 max-w-lg mx-auto md:max-w-none md:mx-0 md:px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 items-start gap-3">
